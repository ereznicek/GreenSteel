...
renewable_cost_path = os.path.join(project_path, "H2_Analysis", "green_steel_site_renewable_costs_ATB_aug2024.xlsx")
floris = False
                    ...
                    for grid_connection_scenario in grid_connection_cases:
                        for storage_capacity_multiplier in storage_capacity_cases:
                            for electrolyzer_cost_case in electrolyzer_cost_cases:
                                ...
                                #if (site_location == 'Site 3' and electrolyzer_cost_case == 'Low') or (atb_year==2022):

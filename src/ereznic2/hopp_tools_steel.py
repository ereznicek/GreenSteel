...
#         cf_solar_annuals = np.zeros(30)`
    ...
    financial_summary_df = pd.DataFrame([scenario['Useful Life'], wind_cost_kw, solar_cost_kw,electrolyzer_installed_cost_kw,
                                            wind_size_mw,solar_size_mw,excess_capacity_percent,storage_size_mw,storage_hours,electrolyzer_size_mw,
                                            ...
                                            lcoh_breakdown['LCOH: Grid Transmission ($/kg)'],
                                            ...
                                            ['Useful Life', 'Wind Cost ($/kW)', 'Solar Cost ($/kW)', 'Electrolyzer Installed Cost ($/kW)',
                                             'Wind capacity (MW)','Solar capacity (MW)','Excess VRE capacity (%)','Battery storage capacity (MW)','Battery storage duration (hr)','Electrolyzer capacity (MW)',
                                            ...
                                            'LCOH: Battery Storage CAPEX ($/kg)','LCOH: Battery Storage FOM ($/kg)','LCOH: Grid Transmission ($/kg)',
